...
public class DataSourceFunctionConfig {
    ...
    @Bean(name = "functionDataSource")
    @ConfigurationProperties(prefix = "spring.datasource.druid.business.assign.order")
    public DataSource functionDataSource() {
        return DruidDataSourceBuilder.create().build();
    }

    @Bean(name = "functionSqlSessionFactory")
    public MybatisSqlSessionFactoryBean functionSqlSessionFactory(@Qualifier("functionDataSource") DataSource callCenterDataSource) throws Exception {
